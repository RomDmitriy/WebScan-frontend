...
function StatusInfoBlock({
  ...
  useEffect(() => {
    ...
    const fetchRepos = async () => {
      ...
      setStatusBlock(<Scanned severities={{ low: data.Low, moderate: data.Moderate, high: data.High }} />);
    };
...
function Scanning() {
  return <p className='w-full h-full flex justify-center items-center text-2xl text-center'>Сканирование в процессе</p>;
}
